...
if __name__ == '__main__':
    ...
    p.add("-pathcsv2", "--path_to_csv2", required=False, help="path to final csv 2", type=str)
    ...
    path_to_final_csv2 = options.path_to_csv2
    ...
    df_user_id.to_csv(path_to_final_csv, index=False, header=False)
    df_with_user_id.to_csv(path_to_final_csv2, index=False, header=False)
